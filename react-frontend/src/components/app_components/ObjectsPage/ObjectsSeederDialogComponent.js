...
import seederData from "./objects.seeder.json";
...
const ObjectsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ObjectsSeederDialogComponent);
